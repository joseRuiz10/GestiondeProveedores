...
using TFIGestionProveedores03;

namespace TFIGestionProveedores03.Controllers
{
    public class EquipoesController : Controller
    {
        private dbGestionProveedores02Entities db = new dbGestionProveedores02Entities();

        // GET: Equipoes
        public ActionResult Index(string descripcion)
        {
            var equipos = db.Equipo.Where<Equipo>(e => e.descripcion.Contains(descripcion)).Include(p => p.Proveedor);
